...
class ANETproposal(object):
    ...
    def __init__(self, ground_truth_json=None, proposal_json=None,
        ...
        self.ground_truth, self.activity_index = self._import_ground_truth(
            ground_truth_json)
        self.proposal = self._import_proposal(proposal_json)
    ...
    def _import_ground_truth(self, ground_truth_json):
    ...
    def _import_proposal(self, proposal_json):
    ...
    def evaluate(self):
        ...
        self.area_under_the_ar_vs_an_curve = area_under_curve

        return recall, avg_recall, proposals_per_video, area_under_curve, area_under_curve
